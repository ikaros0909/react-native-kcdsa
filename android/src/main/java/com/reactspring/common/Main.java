...
public class Main {
	...
	public static void main(String[] args) {
		...
		KCDSA.KISA_KCDSA_GenerateKeyPair(kcdsa, pbSrc, 160, qlen, KCDSA.SHA_224);

		siglen = KCDSA.KISA_KCDSA_sign(kcdsa, msg, 39, sig, KCDSA.SHA_224, kInput, 20);
		...
		ret = KCDSA.KISA_KCDSA_verify(kcdsa, msg, 39, sig, siglen, KCDSA.SHA_224);
		if(ret != KCDSA.CTR_SUCCESS) System.out.printf("signature verify error!!");
