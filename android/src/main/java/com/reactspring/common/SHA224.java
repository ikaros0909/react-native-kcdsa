...
public class SHA224 {
	public final static int SHA224_K[] = {0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 0x59f111f1,
	...
	public static void SHA224_Init(SHA_ALG_INFO AlgInfo) {
	...
	public static void SHA224_Update(SHA_ALG_INFO AlgInfo, byte[] Message, int MessageLen) {
		...
		while( MessageLen>=64 ) {
			...
			SHA224_Transform(AlgInfo.Buffer, AlgInfo.ChainVar);
			Message_offset += 64;
			MessageLen -= 64;
		}
	...
	public static void SHA224_Update(SHA_ALG_INFO AlgInfo, int Message, int MessageLen) {
		int RemainedLen;
	...
	public static void SHA224_Final(SHA_ALG_INFO AlgInfo, byte[] Digest) {
	...
	public static void SHA224_Transform(byte[] Message, int[] ChainVar) {
		int j;
		int[] X = new int[64];
	...
	public static void FF(int[] abcdefgh, int a, int b, int c, int d, int e, int f, int g, int h, int[] X, int j) {
		int T1;
		T1 = abcdefgh[h] + Sigma1(abcdefgh[e]) + Ch(abcdefgh[e], abcdefgh[f], abcdefgh[g]) + SHA224_K[j] + X[j];
